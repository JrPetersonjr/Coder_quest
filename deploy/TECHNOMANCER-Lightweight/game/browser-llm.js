...
//   - Specialized model routing for different game tasks
//
// MODELS SUPPORTED:
//   - TinyLlama (1.1B) - Fast, good for NPCs and quick responses
//   - Hermes-2-Pro (7B) - Better quality for complex reasoning (optional)
//   - DialoGPT (600MB) - Ultra-lightweight dialogue system
//   - Task-specific routing based on game content type
//
// DEPLOYMENT OPTIONS:
//   1. Lightweight: TinyLlama only (~1.1GB total)
//   2. Standard: TinyLlama + DialoGPT (~1.7GB total)  
//   3. Premium: All models including Hermes-2-Pro (~5GB total)
// ============================================================
...
window.BrowserLLM = {
  ...
  config: {
    ...
    // Deployment tiers - choose based on target audience and bandwidth
    deploymentTier: "standard", // "lightweight", "standard", or "premium"
    
    // Specialized models for different game tasks
    models: {
      // NPCs and quick dialogue (always loaded)
      npc: {
        name: "TinyLlama/TinyLlama-1.1B-Chat-v1.0",
        size: "1.1GB",
        priority: 1,
        tasks: ["npc_dialogue", "ambient_text", "quick_responses"]
      },
      
      // Content generation and descriptions (lightweight deployment)
      content: {
        name: "microsoft/DialoGPT-medium", 
        size: "600MB",
        priority: 2,
        tasks: ["world_descriptions", "ui_text", "flavor_text"]
      },
      
      // Deep reasoning for puzzles and complex logic (premium deployment)
      reasoning: {
        name: "NousResearch/Hermes-2-Pro-Mistral-7B",
        size: "4GB", 
        priority: 3,
        tasks: ["battle_strategy", "puzzle_solving", "complex_narratives"],
        onlyInPremium: true
      }
    },
    ...
    fallbackModel: "microsoft/DialoGPT-medium", // Lighter fallback
    maxTokens: 150,
    temperature: 0.8,
